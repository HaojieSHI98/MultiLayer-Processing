...
/home/siqiang/MPR/TOAIN/TOAIN -multicore $1 -part 1 -configtime 10  -method toain -threshold 0 -parmethod rand -out _NY_${cores}_${objects}_${configstr} -single_aggr 1  -init $objects -layer 1 -toaintype q -network NY -DISPLAY $5 -configstr $3 -mode $6
