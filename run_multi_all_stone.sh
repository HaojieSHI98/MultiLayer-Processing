...
/home/siqiang/MPR/TOAIN/TOAIN -multicore $1 -part 1 -configtime 10 -testtime 50 -testtime2 50 -method dijk -threshold 0 -parmethod rand -out _NY_${cores}_${objects}_${updateratio}_${quratio}_${updateratio2}_${quratio2}_time_${testtime}_${testtime2} -single_aggr 1 -query $querynum -insert $insertnum -delete $deletenum -query2 $querynum2 -insert2 $insertnum2 -delete2 $deletenum2 -init $objects -layer 1 -toaintype q -network NY -DISPLAY $6
